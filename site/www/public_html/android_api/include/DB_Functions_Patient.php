...
class DB_Functions_Patient {
    ...
    public function storePatient($name, $email, $password, $address, $telephone) {
        ...
        if ($resultP) {
            ...
            $result = mysql_query("SELECT * FROM per_all_people_f WHERE person_id = $personId AND person_type = 'P'");
    ...
    public function getPatientByEmail($email) {
        $result = mysql_query("SELECT * FROM per_all_people_f WHERE email = '$email' AND person_type = 'P'") or die(mysql_error());
        // check for result 
